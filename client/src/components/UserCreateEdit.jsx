...
export default function UserCreateEdit({ onClose, createUserHandler, editUserHandler, userId }) {
            ...
            <div className="modal">
                <div className="user-container">
                    ...
                    <form>
                        ...
                        <div id="form-actions">
                            {userId ?
                                <button id="action-save" className="btn" type="submit" onClick={(e) => { editUserHandler(e, user._id, user.createdAt) }} >Edit</button>
                                : <button id="action-save" className="btn" type="submit" onClick={createUserHandler}>Save</button>
                            }
