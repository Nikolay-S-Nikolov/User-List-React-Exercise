...
export default function UserItem({ userData, onUserDetailsClick, onEditClick, onDeleteClick }) {
    return (
        <tr>
            <td>
                <img src={userData.imageUrl} alt={`${userData.firstName}'s profile`} className="image" />
            </td>
            <td>{userData.firstName}</td>
            <td>{userData.lastName}</td>
            <td>{userData.email}</td>
            <td>{userData.phoneNumber}</td>
            <td>{fromIsoDate(userData.createdAt)}</td>

            <td className="actions">
                <button className="btn edit-btn" title="Edit" onClick={() => onEditClick(userData._id)}>
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => onDeleteClick(userData._id)}>
                ...
                <button className="btn info-btn" title="Info" onClick={() => onUserDetailsClick(userData._id)}>
